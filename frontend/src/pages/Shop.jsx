...
const Shop = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        <button 
        onClick={() => navigate("/")}
        className="absolute top-4 left-4 z-20 flex items-center gap-2 bg-black/50 hover:bg-black/70 text-white px-3 py-1 rounded-full shadow transition cursor-pointer">
          <FaArrowLeftLong />
          <span>Back</span>
        </button>
      {shop && (
